# Hi there, I'm Nischal Sherchan! 👋

Frontend Developer based in Nepal, building dynamic, responsive, and interactive user interfaces — currently leveling up into Full Stack Development.
...
**[Cafe Landing & Dashboard](https://cafe.sangamshrestha007.com.np/)**
A fully dynamic, full-stack cafe platform where all frontend content (menus, links, reservations) is rendered in real-time from a PostgreSQL database. Features an immersive 3D UI with animated coffee beans that burst on scroll, built using ThreeJS and GSAP.
*   **Frontend:** Next.js · Three.js · GSAP · Tailwind CSS
...
*Open to Frontend / Full Stack opportunities — feel free to reach out!*
